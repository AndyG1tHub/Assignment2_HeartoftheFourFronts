 ...
 * One cell on the grid map with terrain type and optional building.
 * Owns cosmetic fields for map terrain variant and obstacle variant.
 * isWalkable() returns false for obstacles and tiles with living buildings.
 * isBuildable() returns true only for empty tiles with no existing building.
 */
package core;
